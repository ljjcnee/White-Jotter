...
CREATE TABLE `jotter_article` (
  ...
  `article_content_html` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `article_content_md` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
